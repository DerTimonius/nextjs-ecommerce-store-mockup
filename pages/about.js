    ...
    <div>
      ...
      <main css={aboutStyles}>
        ...
        <p>
          ...
          e-commerce store (aside from it being fake of course). So adding stuff
          to your cart, deleting stuff from your cart, changing the quantity of
          the products, whatever you can imagine from a typical store.
        </p>
      </main>
    </div>
  );
